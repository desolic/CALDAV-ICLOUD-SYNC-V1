...
if mkdir -p "$LOG_DIR"; then
    echo "✅ Logs-Verzeichnis erstellt: $LOG_DIR" | tee -a "$LOG_FILE"
else
    echo "❌ Fehler beim Erstellen des Logs-Verzeichnisses: $LOG_DIR" | tee -a "$LOG_FILE"
fi
...
# Debug: Inhalt der Config prüfen
